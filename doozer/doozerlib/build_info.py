...
from doozerlib.repodata import OutdatedRPMFinder, Repodata, RepodataCache
...
class KonfluxBuildRecordInspector(BuildRecordInspector):
    ...
    async def find_non_latest_rpms(self, package_rpm_finder: PackageRpmFinder, repodata_cache: RepodataCache):
        meta = self.get_image_meta()
        logger = meta.logger or self.runtime.logger
        ...
        for arch in self._build_record.arches:
            ...
            repodatas = await repodata_cache.get_repodata(arch, enabled_repos)
